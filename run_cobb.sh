...
benchmarks=('sortedlist' 'even_list' 'list_incr_one' 'list_trues' 'len_even_list' 'list_twos_even_len' 'len_k_list' 'list_twos_len_k' 'unique_list' 'duplicatelist' 'depthtree' 'complete_tree' 'nonemptytree' 'twos_tree' 'rbtree_busted' 'depth_bst' 'equals2' 'equals2or5' 'gt5' 'stlc_gen_term')
