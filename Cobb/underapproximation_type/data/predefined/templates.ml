...
let[@axiom] template_eq_2 (x : int) = x == 2
let[@axiom] template_eq_5 (x : int) = x == 5
let[@axiom] template_eq_true (x : bool) = x
...
let[@axiom] template_incr_one (l : int list) = incr_one l
